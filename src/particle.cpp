...
void particle::mix_colors() {
  // For readability
  int c_red = (getr(colorStart) * life + getr(colorEnd) * (life_start - life)) /
              life_start;
  int c_green =
      (getg(colorStart) * life + getg(colorEnd) * (life_start - life)) /
      life_start;
  int c_blue =
      (getb(colorStart) * life + getb(colorEnd) * (life_start - life)) /
      life_start;
